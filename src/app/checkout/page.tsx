  ...
  return (
    <div>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
        ...
        height={90}
        />
        <h1 className="text-[48px] font-medium mt-[-30px] text-black">Checkout</h1>
        <p className="text-[16px] font-medium text-black pt-2">Home  <AiOutlineRight className='inline-block' />
 <span className='font-light'> Checkout</span></p>
      </div>
...
<div className="min-h-screen  flex justify-center items-center">
      <div className="container mx-auto p-8 mt-6">
        <div className="grid grid-cols-1 md:grid-cols-2  my-8">
          {/* Billing Details */}
          <div className="bg-white px-32 rounded ">
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="mt-2 block w-full border border-[#9F9F9F] rounded-[6px] p-4 focus:outline-none focus:ring-2 focus:ring-black"
                  />
                </div>
                <div>
                  <label className="block text-[16px] font-medium mb-4">
 ...
 />
              ...
              <div>
                ...
                <select className='mt-2 block w-full border border-[#9F9F9F] rounded-[6px] p-4 focus:outline-none focus:ring-2 focus:ring-black'>
              ...
              <div>
                ...
                className='mt-14 block w-full border placeholder:text-[16px] placeholder:text-[#9F9F9F] border-[#9F9F9F] rounded-[6px] p-4 focus:outline-none focus:ring-2 focus:ring-black'
      ...
      <div className="flex justify-between items-center  pb-2 mb-2">
        <p className="text-[16px] text-[#9F9F9F]">Asgaard sofa <span className='text-black font-medium'><span className='px-2'>X</span> 1</span></p>
      ...
      <form>
        ...
        <div className="mb-4">
          <label className="flex items-center space-x-2">
            <input
              ...
              defaultChecked
            />
            <span className="text-[16px] pl-2">Direct Bank Transfer</span>
          </label>
        ...
        Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.
            ...
            />
            <span className="text-[16px] text-[#9F9F9F] pl-2">Direct Bank Transfer</span>
                                  </label>
  ...
  <input
    ...
    className="w-4 h-4 text-black focus:ring-0 focus:bg-black "
  />
  <span className="text-[16px] text-[#9F9F9F] pl-2">Cash on Delivery</span>
</label>
        ...
        <div className='flex justify-center mt-8'>
                                    ...
                                    <button
          type="submit"
          className=" py-3 px-20  border border-black rounded-[12px] text-black text-center hover:bg-black hover:text-white duration-200"
        >
          Place order
        </button>
        </div>
