  ...
  return (
    <div>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
        ...
        height={90}
        />
        <h1 className="text-[48px] font-medium mt-[-30px] text-black">Blog</h1>
        <p className="text-[16px] font-medium text-black pt-2">Home  <AiOutlineRight className='inline-block' />
 <span className='font-light'> Blog</span></p>
      </div>
    ...
    <div className=" mt-20  flex-[3]">
     
      {/* Grid Container */}
      <div className="grid grid-cols-1 gap-10 w-[80%]">
        {blogs.map((blog) => (
          <div
            key={blog.id}
          ...
          >
            ...
            {/* Blog Content */}
                <div className="py-6">
                    <div className="text-[16px] text-[#9F9F9F] mb-3 flex gap-4">
              ...
              <p className="text-[#9F9F9F] text-[15px] mb-4">{blog.description}</p>
              <button className="text-black mt-5  text-[16px] font-semibold underline underline-offset-8 ">
                Read more
              </button>
            </div>
          </div>
          ...
          {/* category section */}
              <div className='mt-20 relative -left-16'>
                   {/* Search Bar */}
      <div className="mb-">
         <input
          type="text"
      ...
      <div className='px-4 mt-20'>
        ...
        <button className="h-[60px] text-[18px] w-[60px] bg-[#FFF9E5]  hover:bg-[#FBEBB5] rounded-[10px] text-black">2</button>
        <button className="h-[60px] text-[18px] w-[60px] bg-[#FFF9E5]  hover:bg-[#FBEBB5] rounded-[10px] text-black">3</button>
        <button className="h-[60px] text-[18px] w-[98px] bg-[#FFF9E5]  hover:bg-[#FBEBB5] rounded-[10px] text-black">Next</button>
      </div>
          <Delivery/>
          </div>
  )
