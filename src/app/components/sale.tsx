    ...
    <div className='bg-[#FFF9E5] flex md:flex-row flex-col md:gap-28 '>
      <div className='px-5 md:px-0'>
          ...
          <div className='flex flex-col justify-center items-center mt-7 md:mt-0 mb-10 md:mb-0'>
              ...
              <button className='text-[16px] md:text-[20px] px-8 py-1.5 md:px-14 md:py-3 border mt-4 md:mt-8 hover:bg-black hover:text-white duration-200 border-black text-center'>Order Now</button>
          </div>
    </div>
  )
}
