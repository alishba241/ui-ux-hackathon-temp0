...
const Blog = () => {
  return (
    <div className="flex flex-col items-center justify-center px-6 py-20 bg-white">
      {/* Heading Section */}
      <h1 className="text-[36px] font-medium text-center">Our Blogs</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20">
        {/* Blog Card */}
        <div className="hover:shadow-lg w-[287px] h-[397px] flex flex-col items-center rounded-[4px] p-4">
          {/* Blog Image */}
          ...
          <div className="w-full flex flex-col items-center mt-[35px]">
            ...
            <a
              href="#"
              className="mt-3 text-[18px]  font-medium text-black underline underline-offset-[13px] decoration-2"
            >
              Read More
            </a>
